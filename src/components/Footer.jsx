          ...
          <div className="footer-section">
            ...
            <div className="social-links">
              ...
              {portfolioData.social.twitter && (
                <a href={portfolioData.social.twitter} target="_blank" rel="noopener noreferrer" className="social-link">
                  <svg viewBox="0 0 24 24" width="24" height="24">
              ...
              {portfolioData.social.email && (
                <a href={portfolioData.social.email} className="social-link">
                  <svg viewBox="0 0 24 24" width="24" height="24">
